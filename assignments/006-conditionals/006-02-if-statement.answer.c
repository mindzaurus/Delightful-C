...
{ // Begin Function if_multiplier
  ...
  //    This is because y * 1 is y
  if(x == 1) { // check whether x is equal to 1
    printf("if_multiplier: x == 1 so returning y directly no multiplication\n");
    return y;
  }
