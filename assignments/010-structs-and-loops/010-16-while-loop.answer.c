...
//    Remember to stop the loop by incrementing variable i correctly, if you don't
//    increment the value of i you will get an infinite loop
void simple_while_loop()
{
  int i = 0;
  while(i <= 5)
  {
    i++;
    printf("simple_while_loop i = %d \n", i);
  }
}
...
void simple_while_loop_with_break()
{
  int i = 0;
  while(i <= 5)
  {
    ...
    printf("simple_while_loop_with_break %d \n", i);
  }
}
...
//    Remember to stop the loop by incrementing variable i correctly, if you don't
//    increment the value of i you will get an infinite loop
void simple_while_loop_with_continue()
{
  int i = 0;
  while(i <= 5)
  {
    ...
    printf("simple_while_loop_with_continue %d \n", i);
  }
}
...
int main()
{
  ...
  // 10) Call the function simple_while_loop_with_continue will see a range of values
  //     printed
  simple_while_loop_with_continue();
