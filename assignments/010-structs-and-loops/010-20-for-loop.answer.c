...
//    Increment i in for statement using i++, if you don't
//    you will get an infinite loop
void simple_for_loop_with_break()
{
  int i = -1;
  ...
  for(i = 0; i<=5; i++)
  {
    ...
    printf("simple_for_loop_with_break %d \n", i);
  }
}
...
//    Increment i in for statement using i++, if you don't
//    you will get an infinite loop
void simple_for_loop_with_continue()
{
  int i = 0;
  ...
  for(i = 0; i<=5; i++)
  {
    ...
    printf("simple_for_loop_with_continue %d \n", i);
  }
}
